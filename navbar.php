...
<nav class="navbar navbar-expand-lg navbar-dark bg-green">
    <a class="navbar-brand font-weight-bold" href="index.php">SMK Negeri 1 Wanareja</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle <?= $aktif == 'visi_misi' || $aktif == 'bukutamu' || $aktif == 'tentang_website' ? 'active' : '' ?>" href="#" id="dropdownInfo" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    INFO
                </a>
