...
<div class="col-sm-4">
	<div class="list-group">
		<span class="list-group-item text-white" style="background-color: #388E3C">Artikel Terbaru</span>
	...
	<div class="list-group">
		<span class="list-group-item text-white mt-3" style="background-color: #388E3C">Kategori Artikel</span>
